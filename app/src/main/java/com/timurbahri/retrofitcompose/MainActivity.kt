package com.timurbahri.retrofitcompose
...
import com.timurbahri.retrofitcompose.service.CryptoAPI
import com.timurbahri.retrofitcompose.ui.theme.RetrofitComposeTheme
...
fun AppBar() {
    TopAppBar(contentPadding = PaddingValues(10.dp)) {
        Text(text = "Retrofit Compose",fontSize = 25.sp)
    }
}
...
fun DefaultPreview() {
    RetrofitComposeTheme {
        CryptoRow(crypto = CryptoModel("BTC","8877"))
    }
}